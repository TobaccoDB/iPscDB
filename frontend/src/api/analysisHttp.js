...
const axios = Axios.create({
    // baseURL: 'http://172.16.17.7:80', //正式
    // baseURL: 'http://8.210.133.110:80', // 测试
    // baseURL: 'http://47.238.201.200:80', // 测试
    // baseURL: 'http://218.28.140.59:8083', //正式
    baseURL: process.env.VUE_APP_ANALYSIS_URL, //最终版本
    timeout: 3000000
})
