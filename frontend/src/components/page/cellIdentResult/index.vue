<template>
    <div class="cellIdentResult">
        <div class="crumbs">
            <el-breadcrumb v-if="$route.query.file_name" separator-class="el-icon-arrow-right">
                <el-breadcrumb-item :to="{ path: '/cellIdentification' }">Cell Identification</el-breadcrumb-item>
                <el-breadcrumb-item :to="{ path: `/cellIdent?lit_id=${this.$route.query.lit_id}&species_name=${this.$route.query.species_name}&tissue=${this.$route.query.tissue}` }"
                    >Cell Ident</el-breadcrumb-item
                >
                <el-breadcrumb-item>Cell Identification Result</el-breadcrumb-item>
            </el-breadcrumb>

            <el-breadcrumb v-else-if="$route.query.pageType" separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item
                    :to="{
                        path: `/sampleQCFilter?tissue=${this.$route.query.tissue}&species_name=${this.$route.query.species_name}&sample_id=${this.$route.query.sample_id}&files_uuid=${this.$route.query.files_uuid}&file_type=${this.$route.query.file_type}&pageType=${this.$route.query.pageType}`
                    }"
                    >QC filter</el-breadcrumb-item
                >
                <el-breadcrumb-item>Cell Identification Result</el-breadcrumb-item>
            </el-breadcrumb>
            <el-breadcrumb v-else separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item
                    :to="{
                        path: `/sampleDetails?tissue=${this.$route.query.tissue}&species_name=${this.$route.query.species_name}&sample_id=${this.$route.query.sample_id}&files_uuid=${this.$route.query.files_uuid}&file_type=${this.$route.query.file_type}`
                    }"
                    >File Upload</el-breadcrumb-item
                >
                <el-breadcrumb-item
                    :to="{
                        path: `/sampleQCFilter?tissue=${this.$route.query.tissue}&species_name=${this.$route.query.species_name}&sample_id=${this.$route.query.sample_id}&files_uuid=${this.$route.query.files_uuid}&file_type=${this.$route.query.file_type}`
                    }"
                    >QC filter</el-breadcrumb-item
                >
                <el-breadcrumb-item>Cell Identification Result</el-breadcrumb-item>
        ...
        <div class="cellIdentResult-inner" :style="{ minHeight: contentHeight }" v-loading="goLoading" element-loading-text="loading" element-loading-background="#fff">
            <h2>Cell Identification Result</h2>
            <p class="title">
                Cell identification
