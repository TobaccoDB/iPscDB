          ...
          <el-form ref="formData1" :inline="true" :model="data1Form" :rules="data1Rules">
            ...
            <div v-for="(item, index) in data1_List" :key="index">
              <el-form-item label="R1" prop="R1" style="margin-bottom: 0">
                ...
                <div ref="drag" id="drag" class="drag">
                  ...
                  <div class="drag-message">
                    ...
                    <label for="file" class="drag-message-label">
                      <input class="drag-message-input" type="file" id="file" name="file" @change="handleFileChange" />
...
export default {
  ...
  methods: {
    bindEvents() {
      const drag = this.$refs.drag[0]
      console.log(333, drag)
      // 被拖动的对象进入目标容器
